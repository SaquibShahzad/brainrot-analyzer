...
app.layout = html.Div(children=[
    html.Div([
        html.Img(
            src='https://unsplash.com/illustrations/a-man-with-his-head-in-a-tangle-of-wires-oyOME_p66Xg',
            style={'width': '100%', 'height': 'auto'}
        ),
        html.H1("YouTube Browsing History Dashboard", style={'fontSize': '6em', 'textAlign': 'center'})
    ]),
    html.Label("Increase Font Sizes:", style={'fontSize': '3em'}),
    dcc.Slider(
        id='font-slider',
        min=0,
        max=20,
    ...
    html.Br(),
    html.Label("Select Brainrot Categories:", style={'fontSize': '5em'}),
    dcc.Dropdown(
    ...
    dcc.Graph(id='brainrot-pie-chart')
])
